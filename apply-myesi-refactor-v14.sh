#!/bin/bash
set -e
echo "Applying round 14: PSEB logo added, Trusted By names removed, sizes increased, shield icon removed from footer..."

mkdir -p "$(dirname "src/App.tsx")"
cat > "src/App.tsx" << 'R14FILEEOF_0'
/**
 * @license
...
cat > "src/components/About.tsx" << 'R14FILEEOF_1'
...
cat > "src/components/AboutContent.tsx" << 'R14FILEEOF_2'
import { motion } from 'motion/react';
...
cat > "src/components/AuditFeatures.tsx" << 'R14FILEEOF_3'
...
cat > "src/components/ContactHiring.tsx" << 'R14FILEEOF_4'
import { motion } from 'motion/react';
...
cat > "src/components/Footer.tsx" << 'R14FILEEOF_5'
...
cat > "src/components/FormToast.tsx" << 'R14FILEEOF_6'
...
cat > "src/components/Hero.tsx" << 'R14FILEEOF_7'
import { motion } from 'motion/react';
...
cat > "src/components/Navbar.tsx" << 'R14FILEEOF_8'
...
cat > "src/components/PCATeaser.tsx" << 'R14FILEEOF_9'
import { motion } from 'motion/react';
...
cat > "src/components/Packages.tsx" << 'R14FILEEOF_10'
import { motion } from 'motion/react';
import { Link } from 'react-router-dom';
...
cat > "src/components/PartnersSlider.tsx" << 'R14FILEEOF_11'
import { motion } from 'motion/react';
...
cat > "src/components/Product.tsx" << 'R14FILEEOF_12'
import { motion } from 'motion/react';
...
cat > "src/components/SupportSection.tsx" << 'R14FILEEOF_13'
import { useState } from 'react';
import { Link } from 'react-router-dom';
import { motion } from 'motion/react';
import {
...
cat > "src/components/TrustedBy.tsx" << 'R14FILEEOF_14'
import { motion } from 'motion/react';
...
cat > "src/data/complianceData.ts" << 'R14FILEEOF_15'
...
cat > "src/data/newsData.ts" << 'R14FILEEOF_16'
...
cat > "src/data/servicesData.ts" << 'R14FILEEOF_17'
...
cat > "src/data/trainingData.ts" << 'R14FILEEOF_18'
...
cat > "src/hooks/useSubmitForm.ts" << 'R14FILEEOF_19'
...
cat > "src/index.css" << 'R14FILEEOF_20'
...
cat > "src/lib/submitForm.ts" << 'R14FILEEOF_21'
...
cat > "src/main.tsx" << 'R14FILEEOF_22'
...
cat > "src/pages/AboutPage.tsx" << 'R14FILEEOF_23'
...
cat > "src/pages/AllReportsPage.tsx" << 'R14FILEEOF_24'
import { motion } from 'motion/react';
...
cat > "src/pages/CareersPage.tsx" << 'R14FILEEOF_25'
import { motion } from 'motion/react';
...
cat > "src/pages/CompliancePage.tsx" << 'R14FILEEOF_26'
...
cat > "src/pages/ContactPage.tsx" << 'R14FILEEOF_27'
import { ArrowLeft } from 'lucide-react';
import { Link } from 'react-router-dom';
...
cat > "src/pages/CookiePolicyPage.tsx" << 'R14FILEEOF_28'
import { motion } from 'motion/react';
...
cat > "src/pages/DemoPage.tsx" << 'R14FILEEOF_29'
import { motion } from 'motion/react';
...
cat > "src/pages/FeaturesPage.tsx" << 'R14FILEEOF_30'
...
cat > "src/pages/LegalPage.tsx" << 'R14FILEEOF_31'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/MyesiLoginPage.tsx" << 'R14FILEEOF_32'
import { motion } from 'motion/react';
...
cat > "src/pages/PCAPage.tsx" << 'R14FILEEOF_33'
import { useState } from 'react';
import { motion, AnimatePresence } from 'motion/react';
import {
  ArrowLeft,
...
cat > "src/pages/PackagesPage.tsx" << 'R14FILEEOF_34'
import { Navigate } from 'react-router-dom';
...
cat > "src/pages/PrivacyPolicyPage.tsx" << 'R14FILEEOF_35'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/ProductPage.tsx" << 'R14FILEEOF_36'
import { ArrowLeft } from 'lucide-react';
import { Link } from 'react-router-dom';
import Product from '../components/Product';
import AuditFeatures from '../components/AuditFeatures';
...
cat > "src/pages/ServiceDetailPage.tsx" << 'R14FILEEOF_37'
import { motion } from 'motion/react';
...
cat > "src/pages/ServicesPage.tsx" << 'R14FILEEOF_38'
import { motion } from 'motion/react';
...
cat > "src/pages/SimplePage.tsx" << 'R14FILEEOF_39'
import { motion } from 'motion/react';
...
cat > "src/pages/SupportPage.tsx" << 'R14FILEEOF_40'
import { Navigate } from 'react-router-dom';
...
cat > "src/pages/TermsOfServicePage.tsx" << 'R14FILEEOF_41'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/TrainingDetailPage.tsx" << 'R14FILEEOF_42'
import { motion } from 'motion/react';
import { ArrowLeft, Send, CheckCircle2, Loader2 } from 'lucide-react';
import { Link, useParams, Navigate } from 'react-router-dom';
...
cat > "src/pages/company/ExecutiveTeamPage.tsx" << 'R14FILEEOF_43'
import { motion } from 'motion/react';
...
cat > "src/pages/company/InvestorRelationsPage.tsx" << 'R14FILEEOF_44'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/BecomePartnerPage.tsx" << 'R14FILEEOF_45'
...
cat > "src/pages/partners/ComparePlansPage.tsx" << 'R14FILEEOF_46'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/FindPartnerPage.tsx" << 'R14FILEEOF_47'
...
cat > "src/pages/partners/PartnerPortalPage.tsx" << 'R14FILEEOF_48'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/PartnerProgramsPage.tsx" << 'R14FILEEOF_49'
...
cat > "src/pages/resources/CommunityPage.tsx" << 'R14FILEEOF_50'
...
cat > "src/pages/resources/DocumentationPage.tsx" << 'R14FILEEOF_51'
...
cat > "src/pages/resources/TrainingPage.tsx" << 'R14FILEEOF_52'
import { motion } from 'motion/react';
...
cat > "src/pages/resources/TrustPage.tsx" << 'R14FILEEOF_53'
...
cat > "src/vite-env.d.ts" << 'R14FILEEOF_54'

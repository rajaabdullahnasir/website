#!/bin/bash
set -e
echo "Applying round 9: remove Our Story/Team/Looking Ahead, add CEO message + Values to About..."

mkdir -p "$(dirname "src/App.tsx")"
cat > "src/App.tsx" << 'R9FILEEOF_0'
/**
 * @license
...
cat > "src/components/About.tsx" << 'R9FILEEOF_1'
...
cat > "src/components/AboutContent.tsx" << 'R9FILEEOF_2'
import { motion } from 'motion/react';
...
cat > "src/components/AuditFeatures.tsx" << 'R9FILEEOF_3'
...
cat > "src/components/ContactHiring.tsx" << 'R9FILEEOF_4'
import { motion } from 'motion/react';
...
cat > "src/components/Footer.tsx" << 'R9FILEEOF_5'
...
cat > "src/components/FormToast.tsx" << 'R9FILEEOF_6'
...
cat > "src/components/Hero.tsx" << 'R9FILEEOF_7'
import { motion } from 'motion/react';
...
cat > "src/components/Navbar.tsx" << 'R9FILEEOF_8'
...
cat > "src/components/PCATeaser.tsx" << 'R9FILEEOF_9'
import { motion } from 'motion/react';
...
cat > "src/components/Packages.tsx" << 'R9FILEEOF_10'
import { motion } from 'motion/react';
import { Link } from 'react-router-dom';
...
cat > "src/components/PartnersSlider.tsx" << 'R9FILEEOF_11'
import { motion } from 'motion/react';
...
cat > "src/components/Product.tsx" << 'R9FILEEOF_12'
import { motion } from 'motion/react';
...
cat > "src/components/SupportSection.tsx" << 'R9FILEEOF_13'
import { useState } from 'react';
import { Link } from 'react-router-dom';
import { motion } from 'motion/react';
import {
...
cat > "src/components/TrustedBy.tsx" << 'R9FILEEOF_14'
import { motion } from 'motion/react';
...
cat > "src/data/complianceData.ts" << 'R9FILEEOF_15'
...
cat > "src/data/newsData.ts" << 'R9FILEEOF_16'
...
cat > "src/data/servicesData.ts" << 'R9FILEEOF_17'
...
cat > "src/data/trainingData.ts" << 'R9FILEEOF_18'
...
cat > "src/hooks/useSubmitForm.ts" << 'R9FILEEOF_19'
...
cat > "src/index.css" << 'R9FILEEOF_20'
...
cat > "src/lib/submitForm.ts" << 'R9FILEEOF_21'
...
cat > "src/pages/AboutPage.tsx" << 'R9FILEEOF_23'
...
cat > "src/pages/AllReportsPage.tsx" << 'R9FILEEOF_24'
import { motion } from 'motion/react';
...
cat > "src/pages/CareersPage.tsx" << 'R9FILEEOF_25'
import { motion } from 'motion/react';
...
cat > "src/pages/CompliancePage.tsx" << 'R9FILEEOF_26'
...
cat > "src/pages/ContactPage.tsx" << 'R9FILEEOF_27'
import { ArrowLeft } from 'lucide-react';
import { Link } from 'react-router-dom';
...
cat > "src/pages/CookiePolicyPage.tsx" << 'R9FILEEOF_28'
import { motion } from 'motion/react';
...
cat > "src/pages/DemoPage.tsx" << 'R9FILEEOF_29'
import { motion } from 'motion/react';
...
cat > "src/pages/LegalPage.tsx" << 'R9FILEEOF_30'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/MyesiLoginPage.tsx" << 'R9FILEEOF_31'
import { motion } from 'motion/react';
...
cat > "src/pages/PCAPage.tsx" << 'R9FILEEOF_32'
import { motion } from 'motion/react';
import {
  ArrowLeft,
  Users,
...
cat > "src/pages/PrivacyPolicyPage.tsx" << 'R9FILEEOF_33'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/ServiceDetailPage.tsx" << 'R9FILEEOF_34'
import { motion } from 'motion/react';
...
cat > "src/pages/ServicesPage.tsx" << 'R9FILEEOF_35'
import { motion } from 'motion/react';
...
cat > "src/pages/SimplePage.tsx" << 'R9FILEEOF_36'
import { motion } from 'motion/react';
...
cat > "src/pages/TermsOfServicePage.tsx" << 'R9FILEEOF_37'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/TrainingDetailPage.tsx" << 'R9FILEEOF_38'
import { motion } from 'motion/react';
import { ArrowLeft, Send, CheckCircle2, Loader2 } from 'lucide-react';
import { Link, useParams, Navigate } from 'react-router-dom';
...
cat > "src/pages/company/ExecutiveTeamPage.tsx" << 'R9FILEEOF_39'
import { motion } from 'motion/react';
...
cat > "src/pages/company/InvestorRelationsPage.tsx" << 'R9FILEEOF_40'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/BecomePartnerPage.tsx" << 'R9FILEEOF_41'
...
cat > "src/pages/partners/ComparePlansPage.tsx" << 'R9FILEEOF_42'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/FindPartnerPage.tsx" << 'R9FILEEOF_43'
...
cat > "src/pages/partners/PartnerPortalPage.tsx" << 'R9FILEEOF_44'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/PartnerProgramsPage.tsx" << 'R9FILEEOF_45'
...
cat > "src/pages/resources/CommunityPage.tsx" << 'R9FILEEOF_46'
...
cat > "src/pages/resources/DocumentationPage.tsx" << 'R9FILEEOF_47'
...
cat > "src/pages/resources/TrainingPage.tsx" << 'R9FILEEOF_48'
import { motion } from 'motion/react';
...
cat > "src/pages/resources/TrustPage.tsx" << 'R9FILEEOF_49'

#!/bin/bash
set -e
echo "Applying round 12: live EmailJS credentials wired in..."

mkdir -p "$(dirname "src/App.tsx")"
cat > "src/App.tsx" << 'R12FILEEOF_0'
/**
 * @license
...
cat > "src/components/About.tsx" << 'R12FILEEOF_1'
...
cat > "src/components/AboutContent.tsx" << 'R12FILEEOF_2'
import { motion } from 'motion/react';
...
cat > "src/components/AuditFeatures.tsx" << 'R12FILEEOF_3'
...
cat > "src/components/ContactHiring.tsx" << 'R12FILEEOF_4'
import { motion } from 'motion/react';
...
cat > "src/components/Footer.tsx" << 'R12FILEEOF_5'
...
cat > "src/components/FormToast.tsx" << 'R12FILEEOF_6'
...
cat > "src/components/Hero.tsx" << 'R12FILEEOF_7'
import { motion } from 'motion/react';
...
cat > "src/components/Navbar.tsx" << 'R12FILEEOF_8'
...
cat > "src/components/PCATeaser.tsx" << 'R12FILEEOF_9'
import { motion } from 'motion/react';
...
cat > "src/components/Packages.tsx" << 'R12FILEEOF_10'
import { motion } from 'motion/react';
import { Link } from 'react-router-dom';
...
cat > "src/components/PartnersSlider.tsx" << 'R12FILEEOF_11'
import { motion } from 'motion/react';
...
cat > "src/components/Product.tsx" << 'R12FILEEOF_12'
import { motion } from 'motion/react';
...
cat > "src/components/SupportSection.tsx" << 'R12FILEEOF_13'
import { useState } from 'react';
import { Link } from 'react-router-dom';
import { motion } from 'motion/react';
import {
...
cat > "src/components/TrustedBy.tsx" << 'R12FILEEOF_14'
import { motion } from 'motion/react';
...
cat > "src/data/complianceData.ts" << 'R12FILEEOF_15'
...
cat > "src/data/newsData.ts" << 'R12FILEEOF_16'
...
cat > "src/data/servicesData.ts" << 'R12FILEEOF_17'
...
cat > "src/data/trainingData.ts" << 'R12FILEEOF_18'
...
cat > "src/hooks/useSubmitForm.ts" << 'R12FILEEOF_19'
...
cat > "src/index.css" << 'R12FILEEOF_20'
...
cat > "src/lib/submitForm.ts" << 'R12FILEEOF_21'
...
cat > "src/main.tsx" << 'R12FILEEOF_22'
...
cat > "src/pages/AboutPage.tsx" << 'R12FILEEOF_23'
...
cat > "src/pages/AllReportsPage.tsx" << 'R12FILEEOF_24'
import { motion } from 'motion/react';
...
cat > "src/pages/CareersPage.tsx" << 'R12FILEEOF_25'
import { motion } from 'motion/react';
...
cat > "src/pages/CompliancePage.tsx" << 'R12FILEEOF_26'
...
cat > "src/pages/ContactPage.tsx" << 'R12FILEEOF_27'
import { ArrowLeft } from 'lucide-react';
import { Link } from 'react-router-dom';
...
cat > "src/pages/CookiePolicyPage.tsx" << 'R12FILEEOF_28'
import { motion } from 'motion/react';
...
cat > "src/pages/DemoPage.tsx" << 'R12FILEEOF_29'
import { motion } from 'motion/react';
...
cat > "src/pages/LegalPage.tsx" << 'R12FILEEOF_30'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/MyesiLoginPage.tsx" << 'R12FILEEOF_31'
import { motion } from 'motion/react';
...
cat > "src/pages/PCAPage.tsx" << 'R12FILEEOF_32'
import { motion } from 'motion/react';
import {
  ArrowLeft,
  Users,
...
cat > "src/pages/PrivacyPolicyPage.tsx" << 'R12FILEEOF_33'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/ServiceDetailPage.tsx" << 'R12FILEEOF_34'
import { motion } from 'motion/react';
...
cat > "src/pages/ServicesPage.tsx" << 'R12FILEEOF_35'
import { motion } from 'motion/react';
...
cat > "src/pages/SimplePage.tsx" << 'R12FILEEOF_36'
import { motion } from 'motion/react';
...
cat > "src/pages/TermsOfServicePage.tsx" << 'R12FILEEOF_37'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/TrainingDetailPage.tsx" << 'R12FILEEOF_38'
import { motion } from 'motion/react';
import { ArrowLeft, Send, CheckCircle2, Loader2 } from 'lucide-react';
import { Link, useParams, Navigate } from 'react-router-dom';
...
cat > "src/pages/company/ExecutiveTeamPage.tsx" << 'R12FILEEOF_39'
import { motion } from 'motion/react';
...
cat > "src/pages/company/InvestorRelationsPage.tsx" << 'R12FILEEOF_40'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/BecomePartnerPage.tsx" << 'R12FILEEOF_41'
...
cat > "src/pages/partners/ComparePlansPage.tsx" << 'R12FILEEOF_42'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/FindPartnerPage.tsx" << 'R12FILEEOF_43'
...
cat > "src/pages/partners/PartnerPortalPage.tsx" << 'R12FILEEOF_44'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/PartnerProgramsPage.tsx" << 'R12FILEEOF_45'
...
cat > "src/pages/resources/CommunityPage.tsx" << 'R12FILEEOF_46'
...
cat > "src/pages/resources/DocumentationPage.tsx" << 'R12FILEEOF_47'
...
cat > "src/pages/resources/TrainingPage.tsx" << 'R12FILEEOF_48'
import { motion } from 'motion/react';
...
cat > "src/pages/resources/TrustPage.tsx" << 'R12FILEEOF_49'
...
cat > "src/vite-env.d.ts" << 'R12FILEEOF_50'
/// <reference types="vite/client" />
R12FILEEOF_50

echo "Done. Now run: npm run dev and test a form submission."
#!/bin/bash
set -e
echo "Applying round 16: code-split every page with React.lazy, chunk vendor libraries..."

mkdir -p "$(dirname "src/App.tsx")"
cat > "src/App.tsx" << 'R16FILEEOF_0'
/**
 * @license
...
cat > "src/components/About.tsx" << 'R16FILEEOF_1'
...
cat > "src/components/AboutContent.tsx" << 'R16FILEEOF_2'
import { motion } from 'motion/react';
...
cat > "src/components/AuditFeatures.tsx" << 'R16FILEEOF_3'
...
cat > "src/components/ContactHiring.tsx" << 'R16FILEEOF_4'
import { motion } from 'motion/react';
...
cat > "src/components/Footer.tsx" << 'R16FILEEOF_5'
...
cat > "src/components/FormToast.tsx" << 'R16FILEEOF_6'
...
cat > "src/components/Hero.tsx" << 'R16FILEEOF_7'
import { motion } from 'motion/react';
...
cat > "src/components/Navbar.tsx" << 'R16FILEEOF_8'
...
cat > "src/components/PCATeaser.tsx" << 'R16FILEEOF_9'
import { motion } from 'motion/react';
...
cat > "src/components/Packages.tsx" << 'R16FILEEOF_10'
import { motion } from 'motion/react';
import { Link } from 'react-router-dom';
...
cat > "src/components/PartnersSlider.tsx" << 'R16FILEEOF_11'
import { motion } from 'motion/react';
...
cat > "src/components/Product.tsx" << 'R16FILEEOF_12'
import { motion } from 'motion/react';
...
cat > "src/components/SupportSection.tsx" << 'R16FILEEOF_13'
import { useState } from 'react';
import { Link } from 'react-router-dom';
import { motion } from 'motion/react';
import {
...
cat > "src/components/TrustedBy.tsx" << 'R16FILEEOF_14'
import { motion } from 'motion/react';
...
cat > "src/data/complianceData.ts" << 'R16FILEEOF_15'
...
cat > "src/data/newsData.ts" << 'R16FILEEOF_16'
...
cat > "src/data/servicesData.ts" << 'R16FILEEOF_17'
...
cat > "src/data/trainingData.ts" << 'R16FILEEOF_18'
...
cat > "src/hooks/useSubmitForm.ts" << 'R16FILEEOF_19'
...
cat > "src/index.css" << 'R16FILEEOF_20'
...
cat > "src/lib/submitForm.ts" << 'R16FILEEOF_21'
...
cat > "src/main.tsx" << 'R16FILEEOF_22'
...
cat > "src/pages/AboutPage.tsx" << 'R16FILEEOF_23'
...
cat > "src/pages/AllReportsPage.tsx" << 'R16FILEEOF_24'
import { motion } from 'motion/react';
...
cat > "src/pages/CareersPage.tsx" << 'R16FILEEOF_25'
import { motion } from 'motion/react';
...
cat > "src/pages/CompliancePage.tsx" << 'R16FILEEOF_26'
...
cat > "src/pages/ContactPage.tsx" << 'R16FILEEOF_27'
import { ArrowLeft } from 'lucide-react';
import { Link } from 'react-router-dom';
...
cat > "src/pages/CookiePolicyPage.tsx" << 'R16FILEEOF_28'
import { motion } from 'motion/react';
...
cat > "src/pages/DemoPage.tsx" << 'R16FILEEOF_29'
import { motion } from 'motion/react';
...
cat > "src/pages/FeaturesPage.tsx" << 'R16FILEEOF_30'
...
cat > "src/pages/LegalPage.tsx" << 'R16FILEEOF_31'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/MyesiLoginPage.tsx" << 'R16FILEEOF_32'
import { motion } from 'motion/react';
...
cat > "src/pages/PCAPage.tsx" << 'R16FILEEOF_33'
import { useState } from 'react';
import { motion, AnimatePresence } from 'motion/react';
import {
  ArrowLeft,
...
cat > "src/pages/PackagesPage.tsx" << 'R16FILEEOF_34'
import { Navigate } from 'react-router-dom';
...
cat > "src/pages/PrivacyPolicyPage.tsx" << 'R16FILEEOF_35'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/ProductPage.tsx" << 'R16FILEEOF_36'
import { ArrowLeft } from 'lucide-react';
import { Link } from 'react-router-dom';
import Product from '../components/Product';
import AuditFeatures from '../components/AuditFeatures';
...
cat > "src/pages/ServiceDetailPage.tsx" << 'R16FILEEOF_37'
import { motion } from 'motion/react';
...
cat > "src/pages/ServicesPage.tsx" << 'R16FILEEOF_38'
import { motion } from 'motion/react';
...
cat > "src/pages/SimplePage.tsx" << 'R16FILEEOF_39'
import { motion } from 'motion/react';
...
cat > "src/pages/SupportPage.tsx" << 'R16FILEEOF_40'
import { Navigate } from 'react-router-dom';
...
cat > "src/pages/TermsOfServicePage.tsx" << 'R16FILEEOF_41'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/TrainingDetailPage.tsx" << 'R16FILEEOF_42'
import { motion } from 'motion/react';
import { ArrowLeft, Send, CheckCircle2, Loader2 } from 'lucide-react';
import { Link, useParams, Navigate } from 'react-router-dom';
...
cat > "src/pages/company/ExecutiveTeamPage.tsx" << 'R16FILEEOF_43'
import { motion } from 'motion/react';
...
cat > "src/pages/company/InvestorRelationsPage.tsx" << 'R16FILEEOF_44'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/BecomePartnerPage.tsx" << 'R16FILEEOF_45'
...
cat > "src/pages/partners/ComparePlansPage.tsx" << 'R16FILEEOF_46'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/FindPartnerPage.tsx" << 'R16FILEEOF_47'
...
cat > "src/pages/partners/PartnerPortalPage.tsx" << 'R16FILEEOF_48'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/PartnerProgramsPage.tsx" << 'R16FILEEOF_49'
...
cat > "src/pages/resources/CommunityPage.tsx" << 'R16FILEEOF_50'
...
cat > "src/pages/resources/DocumentationPage.tsx" << 'R16FILEEOF_51'
...
cat > "src/pages/resources/TrainingPage.tsx" << 'R16FILEEOF_52'
import { motion } from 'motion/react';
...
cat > "src/pages/resources/TrustPage.tsx" << 'R16FILEEOF_53'
...
cat > "src/vite-env.d.ts" << 'R16FILEEOF_54'
/// <reference types="vite/client" />
R16FILEEOF_54

mkdir -p "$(dirname "vite.config.ts")"
cat > "vite.config.ts" << 'R16FILEEOF_55'
...
echo "Done. Now run: npm run build - the chunk-size warning should be gone."
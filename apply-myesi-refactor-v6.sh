#!/bin/bash
set -e
echo "Applying round 6: full src sync - direct email forms, light theme, 8 audits, MyESI page merge, PCA episodes, investor relations, footer addresses, expanded about..."

mkdir -p "$(dirname "src/App.tsx")"
cat > "src/App.tsx" << 'R6FILEEOF_0'
/**
 * @license
...
cat > "src/components/About.tsx" << 'R6FILEEOF_1'
...
cat > "src/components/AuditFeatures.tsx" << 'R6FILEEOF_2'
...
cat > "src/components/ContactHiring.tsx" << 'R6FILEEOF_3'
import { motion } from 'motion/react';
...
cat > "src/components/ExploreGrid.tsx" << 'R6FILEEOF_4'
import { motion } from 'motion/react';
...
cat > "src/components/Footer.tsx" << 'R6FILEEOF_5'
...
cat > "src/components/FormToast.tsx" << 'R6FILEEOF_6'
...
cat > "src/components/Hero.tsx" << 'R6FILEEOF_7'
import { motion } from 'motion/react';
...
cat > "src/components/Navbar.tsx" << 'R6FILEEOF_8'
...
cat > "src/components/PCATeaser.tsx" << 'R6FILEEOF_9'
import { motion } from 'motion/react';
...
cat > "src/components/Packages.tsx" << 'R6FILEEOF_10'
import { motion } from 'motion/react';
import { Link } from 'react-router-dom';
...
cat > "src/components/PartnersSlider.tsx" << 'R6FILEEOF_11'
import { motion } from 'motion/react';
...
cat > "src/components/Product.tsx" << 'R6FILEEOF_12'
import { motion } from 'motion/react';
...
cat > "src/components/SupportSection.tsx" << 'R6FILEEOF_13'
import { useState } from 'react';
import { Link } from 'react-router-dom';
import { motion } from 'motion/react';
import {
...
cat > "src/components/TrustedBy.tsx" << 'R6FILEEOF_14'
import { motion } from 'motion/react';
...
cat > "src/data/complianceData.ts" << 'R6FILEEOF_15'
...
cat > "src/data/newsData.ts" << 'R6FILEEOF_16'
...
cat > "src/data/servicesData.ts" << 'R6FILEEOF_17'
...
cat > "src/data/trainingData.ts" << 'R6FILEEOF_18'
...
cat > "src/hooks/useSubmitForm.ts" << 'R6FILEEOF_19'
...
cat > "src/index.css" << 'R6FILEEOF_20'
...
cat > "src/lib/submitForm.ts" << 'R6FILEEOF_21'
...
cat > "src/pages/AboutPage.tsx" << 'R6FILEEOF_23'
import { motion } from 'motion/react';
...
cat > "src/pages/AllReportsPage.tsx" << 'R6FILEEOF_24'
import { motion } from 'motion/react';
...
cat > "src/pages/CareersPage.tsx" << 'R6FILEEOF_25'
import { motion } from 'motion/react';
...
cat > "src/pages/CompliancePage.tsx" << 'R6FILEEOF_26'
...
cat > "src/pages/ContactPage.tsx" << 'R6FILEEOF_27'
...
cat > "src/pages/CookiePolicyPage.tsx" << 'R6FILEEOF_28'
import { motion } from 'motion/react';
...
cat > "src/pages/DemoPage.tsx" << 'R6FILEEOF_29'
import { motion } from 'motion/react';
...
cat > "src/pages/FeaturesPage.tsx" << 'R6FILEEOF_30'
...
cat > "src/pages/LegalPage.tsx" << 'R6FILEEOF_31'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/MyesiLoginPage.tsx" << 'R6FILEEOF_32'
import { motion } from 'motion/react';
...
cat > "src/pages/PCAPage.tsx" << 'R6FILEEOF_33'
import { motion } from 'motion/react';
import {
  ArrowLeft,
  Users,
...
cat > "src/pages/PackagesPage.tsx" << 'R6FILEEOF_34'
import { Navigate } from 'react-router-dom';
...
cat > "src/pages/PrivacyPolicyPage.tsx" << 'R6FILEEOF_35'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/ProductPage.tsx" << 'R6FILEEOF_36'
import { ArrowLeft } from 'lucide-react';
import { Link } from 'react-router-dom';
...
cat > "src/pages/ServiceDetailPage.tsx" << 'R6FILEEOF_37'
import { motion } from 'motion/react';
...
cat > "src/pages/ServicesPage.tsx" << 'R6FILEEOF_38'
import { motion } from 'motion/react';
...
cat > "src/pages/SimplePage.tsx" << 'R6FILEEOF_39'
import { motion } from 'motion/react';
...
cat > "src/pages/SupportPage.tsx" << 'R6FILEEOF_40'
import { Navigate } from 'react-router-dom';
...
cat > "src/pages/TermsOfServicePage.tsx" << 'R6FILEEOF_41'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/TrainingDetailPage.tsx" << 'R6FILEEOF_42'
import { motion } from 'motion/react';
import { ArrowLeft, Send, CheckCircle2, Loader2 } from 'lucide-react';
import { Link, useParams, Navigate } from 'react-router-dom';
...
cat > "src/pages/company/ExecutiveTeamPage.tsx" << 'R6FILEEOF_43'
import { motion } from 'motion/react';
...
cat > "src/pages/company/InvestorRelationsPage.tsx" << 'R6FILEEOF_44'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/BecomePartnerPage.tsx" << 'R6FILEEOF_45'
...
cat > "src/pages/partners/ComparePlansPage.tsx" << 'R6FILEEOF_46'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/FindPartnerPage.tsx" << 'R6FILEEOF_47'
...
cat > "src/pages/partners/PartnerPortalPage.tsx" << 'R6FILEEOF_48'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/PartnerProgramsPage.tsx" << 'R6FILEEOF_49'
...
cat > "src/pages/resources/CommunityPage.tsx" << 'R6FILEEOF_50'
...
cat > "src/pages/resources/DocumentationPage.tsx" << 'R6FILEEOF_51'
...
cat > "src/pages/resources/TrainingPage.tsx" << 'R6FILEEOF_52'
import { motion } from 'motion/react';
...
cat > "src/pages/resources/TrustPage.tsx" << 'R6FILEEOF_53'
...
echo ""
echo "IMPORTANT: Forms will not send email until you set FORM_ENDPOINT in src/lib/submitForm.ts"
echo "Sign up at https://formspree.io, create a form pointed at info@iseewaves.pk, and paste the endpoint there."
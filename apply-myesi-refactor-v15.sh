#!/bin/bash
set -e
echo "Applying round 15: add .htaccess for SPA routing on Apache hosting..."

mkdir -p "$(dirname "public/.htaccess")"
cat > "public/.htaccess" << 'R15FILEEOF_0'
...
cat > "src/components/About.tsx" << 'R15FILEEOF_2'
...
cat > "src/components/AboutContent.tsx" << 'R15FILEEOF_3'
import { motion } from 'motion/react';
...
cat > "src/components/AuditFeatures.tsx" << 'R15FILEEOF_4'
...
cat > "src/components/ContactHiring.tsx" << 'R15FILEEOF_5'
import { motion } from 'motion/react';
...
cat > "src/components/Footer.tsx" << 'R15FILEEOF_6'
...
cat > "src/components/FormToast.tsx" << 'R15FILEEOF_7'
...
cat > "src/components/Hero.tsx" << 'R15FILEEOF_8'
import { motion } from 'motion/react';
...
cat > "src/components/Navbar.tsx" << 'R15FILEEOF_9'
...
cat > "src/components/PCATeaser.tsx" << 'R15FILEEOF_10'
import { motion } from 'motion/react';
...
cat > "src/components/Packages.tsx" << 'R15FILEEOF_11'
import { motion } from 'motion/react';
import { Link } from 'react-router-dom';
...
cat > "src/components/PartnersSlider.tsx" << 'R15FILEEOF_12'
import { motion } from 'motion/react';
...
cat > "src/components/Product.tsx" << 'R15FILEEOF_13'
import { motion } from 'motion/react';
...
cat > "src/components/SupportSection.tsx" << 'R15FILEEOF_14'
import { useState } from 'react';
import { Link } from 'react-router-dom';
import { motion } from 'motion/react';
import {
...
cat > "src/components/TrustedBy.tsx" << 'R15FILEEOF_15'
import { motion } from 'motion/react';
...
cat > "src/data/complianceData.ts" << 'R15FILEEOF_16'
...
cat > "src/data/newsData.ts" << 'R15FILEEOF_17'
...
cat > "src/data/servicesData.ts" << 'R15FILEEOF_18'
...
cat > "src/data/trainingData.ts" << 'R15FILEEOF_19'
...
cat > "src/hooks/useSubmitForm.ts" << 'R15FILEEOF_20'
...
cat > "src/index.css" << 'R15FILEEOF_21'
...
cat > "src/lib/submitForm.ts" << 'R15FILEEOF_22'
...
cat > "src/main.tsx" << 'R15FILEEOF_23'
...
cat > "src/pages/AboutPage.tsx" << 'R15FILEEOF_24'
...
cat > "src/pages/AllReportsPage.tsx" << 'R15FILEEOF_25'
import { motion } from 'motion/react';
...
cat > "src/pages/CareersPage.tsx" << 'R15FILEEOF_26'
import { motion } from 'motion/react';
...
cat > "src/pages/CompliancePage.tsx" << 'R15FILEEOF_27'
...
cat > "src/pages/ContactPage.tsx" << 'R15FILEEOF_28'
import { ArrowLeft } from 'lucide-react';
import { Link } from 'react-router-dom';
...
cat > "src/pages/CookiePolicyPage.tsx" << 'R15FILEEOF_29'
import { motion } from 'motion/react';
...
cat > "src/pages/DemoPage.tsx" << 'R15FILEEOF_30'
import { motion } from 'motion/react';
...
cat > "src/pages/FeaturesPage.tsx" << 'R15FILEEOF_31'
...
cat > "src/pages/LegalPage.tsx" << 'R15FILEEOF_32'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/MyesiLoginPage.tsx" << 'R15FILEEOF_33'
import { motion } from 'motion/react';
...
cat > "src/pages/PCAPage.tsx" << 'R15FILEEOF_34'
import { useState } from 'react';
import { motion, AnimatePresence } from 'motion/react';
import {
  ArrowLeft,
...
cat > "src/pages/PackagesPage.tsx" << 'R15FILEEOF_35'
import { Navigate } from 'react-router-dom';
...
cat > "src/pages/PrivacyPolicyPage.tsx" << 'R15FILEEOF_36'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/ProductPage.tsx" << 'R15FILEEOF_37'
import { ArrowLeft } from 'lucide-react';
import { Link } from 'react-router-dom';
import Product from '../components/Product';
import AuditFeatures from '../components/AuditFeatures';
...
cat > "src/pages/ServiceDetailPage.tsx" << 'R15FILEEOF_38'
import { motion } from 'motion/react';
...
cat > "src/pages/ServicesPage.tsx" << 'R15FILEEOF_39'
import { motion } from 'motion/react';
...
cat > "src/pages/SimplePage.tsx" << 'R15FILEEOF_40'
import { motion } from 'motion/react';
...
cat > "src/pages/SupportPage.tsx" << 'R15FILEEOF_41'
import { Navigate } from 'react-router-dom';
...
cat > "src/pages/TermsOfServicePage.tsx" << 'R15FILEEOF_42'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/TrainingDetailPage.tsx" << 'R15FILEEOF_43'
import { motion } from 'motion/react';
import { ArrowLeft, Send, CheckCircle2, Loader2 } from 'lucide-react';
import { Link, useParams, Navigate } from 'react-router-dom';
...
cat > "src/pages/company/ExecutiveTeamPage.tsx" << 'R15FILEEOF_44'
import { motion } from 'motion/react';
...
cat > "src/pages/company/InvestorRelationsPage.tsx" << 'R15FILEEOF_45'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/BecomePartnerPage.tsx" << 'R15FILEEOF_46'
...
cat > "src/pages/partners/ComparePlansPage.tsx" << 'R15FILEEOF_47'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/FindPartnerPage.tsx" << 'R15FILEEOF_48'
...
cat > "src/pages/partners/PartnerPortalPage.tsx" << 'R15FILEEOF_49'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/PartnerProgramsPage.tsx" << 'R15FILEEOF_50'
...
cat > "src/pages/resources/CommunityPage.tsx" << 'R15FILEEOF_51'
...
cat > "src/pages/resources/DocumentationPage.tsx" << 'R15FILEEOF_52'
...
cat > "src/pages/resources/TrainingPage.tsx" << 'R15FILEEOF_53'
import { motion } from 'motion/react';
...
cat > "src/pages/resources/TrustPage.tsx" << 'R15FILEEOF_54'
...
cat > "src/vite-env.d.ts" << 'R15FILEEOF_55'

#!/bin/bash
set -e
echo "Applying round 8: remove Everything We Offer grid, add full About content to homepage..."

# ExploreGrid no longer used - About content now sits in its place on the homepage
rm -f "src/components/ExploreGrid.tsx"

mkdir -p "$(dirname "src/App.tsx")"
cat > "src/App.tsx" << 'R8FILEEOF_0'
/**
 * @license
...
cat > "src/components/About.tsx" << 'R8FILEEOF_1'
...
cat > "src/components/AboutContent.tsx" << 'R8FILEEOF_2'
import { motion } from 'motion/react';
import { Users, Rocket, Compass } from 'lucide-react';
...
cat > "src/components/AuditFeatures.tsx" << 'R8FILEEOF_3'
...
cat > "src/components/ContactHiring.tsx" << 'R8FILEEOF_4'
import { motion } from 'motion/react';
...
cat > "src/components/Footer.tsx" << 'R8FILEEOF_5'
...
cat > "src/components/FormToast.tsx" << 'R8FILEEOF_6'
...
cat > "src/components/Hero.tsx" << 'R8FILEEOF_7'
import { motion } from 'motion/react';
...
cat > "src/components/Navbar.tsx" << 'R8FILEEOF_8'
...
cat > "src/components/PCATeaser.tsx" << 'R8FILEEOF_9'
import { motion } from 'motion/react';
...
cat > "src/components/Packages.tsx" << 'R8FILEEOF_10'
import { motion } from 'motion/react';
import { Link } from 'react-router-dom';
...
cat > "src/components/PartnersSlider.tsx" << 'R8FILEEOF_11'
import { motion } from 'motion/react';
...
cat > "src/components/Product.tsx" << 'R8FILEEOF_12'
import { motion } from 'motion/react';
...
cat > "src/components/SupportSection.tsx" << 'R8FILEEOF_13'
import { useState } from 'react';
import { Link } from 'react-router-dom';
import { motion } from 'motion/react';
import {
...
cat > "src/components/TrustedBy.tsx" << 'R8FILEEOF_14'
import { motion } from 'motion/react';
...
cat > "src/data/complianceData.ts" << 'R8FILEEOF_15'
...
cat > "src/data/newsData.ts" << 'R8FILEEOF_16'
...
cat > "src/data/servicesData.ts" << 'R8FILEEOF_17'
...
cat > "src/data/trainingData.ts" << 'R8FILEEOF_18'
...
cat > "src/hooks/useSubmitForm.ts" << 'R8FILEEOF_19'
...
cat > "src/index.css" << 'R8FILEEOF_20'
...
cat > "src/lib/submitForm.ts" << 'R8FILEEOF_21'
...
cat > "src/pages/AboutPage.tsx" << 'R8FILEEOF_23'
...
cat > "src/pages/AllReportsPage.tsx" << 'R8FILEEOF_24'
import { motion } from 'motion/react';
...
cat > "src/pages/CareersPage.tsx" << 'R8FILEEOF_25'
import { motion } from 'motion/react';
...
cat > "src/pages/CompliancePage.tsx" << 'R8FILEEOF_26'
...
cat > "src/pages/ContactPage.tsx" << 'R8FILEEOF_27'
import { ArrowLeft } from 'lucide-react';
import { Link } from 'react-router-dom';
...
cat > "src/pages/CookiePolicyPage.tsx" << 'R8FILEEOF_28'
import { motion } from 'motion/react';
...
cat > "src/pages/DemoPage.tsx" << 'R8FILEEOF_29'
import { motion } from 'motion/react';
...
cat > "src/pages/LegalPage.tsx" << 'R8FILEEOF_30'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/MyesiLoginPage.tsx" << 'R8FILEEOF_31'
import { motion } from 'motion/react';
...
cat > "src/pages/PCAPage.tsx" << 'R8FILEEOF_32'
import { motion } from 'motion/react';
import {
  ArrowLeft,
  Users,
...
cat > "src/pages/PrivacyPolicyPage.tsx" << 'R8FILEEOF_33'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/ServiceDetailPage.tsx" << 'R8FILEEOF_34'
import { motion } from 'motion/react';
...
cat > "src/pages/ServicesPage.tsx" << 'R8FILEEOF_35'
import { motion } from 'motion/react';
...
cat > "src/pages/SimplePage.tsx" << 'R8FILEEOF_36'
import { motion } from 'motion/react';
...
cat > "src/pages/TermsOfServicePage.tsx" << 'R8FILEEOF_37'
import { motion } from 'motion/react';
import { Shield } from 'lucide-react';
...
cat > "src/pages/TrainingDetailPage.tsx" << 'R8FILEEOF_38'
import { motion } from 'motion/react';
import { ArrowLeft, Send, CheckCircle2, Loader2 } from 'lucide-react';
import { Link, useParams, Navigate } from 'react-router-dom';
...
cat > "src/pages/company/ExecutiveTeamPage.tsx" << 'R8FILEEOF_39'
import { motion } from 'motion/react';
...
cat > "src/pages/company/InvestorRelationsPage.tsx" << 'R8FILEEOF_40'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/BecomePartnerPage.tsx" << 'R8FILEEOF_41'
...
cat > "src/pages/partners/ComparePlansPage.tsx" << 'R8FILEEOF_42'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/FindPartnerPage.tsx" << 'R8FILEEOF_43'
...
cat > "src/pages/partners/PartnerPortalPage.tsx" << 'R8FILEEOF_44'
import { motion } from 'motion/react';
...
cat > "src/pages/partners/PartnerProgramsPage.tsx" << 'R8FILEEOF_45'
...
cat > "src/pages/resources/CommunityPage.tsx" << 'R8FILEEOF_46'
...
cat > "src/pages/resources/DocumentationPage.tsx" << 'R8FILEEOF_47'
...
cat > "src/pages/resources/TrainingPage.tsx" << 'R8FILEEOF_48'
import { motion } from 'motion/react';
...
cat > "src/pages/resources/TrustPage.tsx" << 'R8FILEEOF_49'
